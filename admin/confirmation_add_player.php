<?php
    ...
    $request_player = $db->prepare("SELECT * FROM `player`");
    $request_player->execute();
    $count_player = $request_player->rowCount();
...
<html lang="fr">
    ...
    <body>
        ...
        <div class="account-management d-flex text-center">
            ...
            <p class="text-center">Lien de ses stats</p>
        </div>
        
        <form method='post' action="add_player.php">
            <div class="account-management d-flex text-center">
                <input class="text-center" type="text" name="id" value="<?php echo htmlspecialchars($count_player, ENT_QUOTES)?>">
                ...
                <input class="text-center" type="text" name="game-stats">
            </div>
