...
<html lang="fr">
    ...
    <body>
        ...
        <div class="account-management d-flex text-center">
            ...
            <?php
            if($_GET['mode'] == "edit") {
                ?><a class="ten" href='./confirmation_edit_staff.php?id=<?php echo htmlspecialchars($data_staff['id'], ENT_QUOTES) ?>'>Modifier</a><?php
            }
            else {
                ?><a class="ten" href='./confirmation_delete_staff.php?id=<?php echo htmlspecialchars($data_staff['id'], ENT_QUOTES) ?>'>Supprimer</a><?php
            }
            ?>
        </div>
        <?php
