<?php
    ...
    $update_news = $db->prepare("INSERT INTO `player` (`id`, `name`,`firstname`,`nickname`, `nationality`, `birthday`, `city`, `size`, `weight`, `team-arrival`, `game-id`, `image`, `twitter`, `instagram`, `twitch`, `game-stats`, `type`) VALUES (:id, :name, :firstname, :nickname, :nationality, :birthday, :city, :size, :weight, :team_arrival, :game_id, :image, :twitter, :instagram, :twitch, :game_stats,'player')");
    $update_news->execute([
        'id' => $player_add_id,
        'name' => $player_add_name,
        'firstname' => $player_add_firstname,
        'nickname' => $player_add_nickname,
        'nationality' => $player_add_nationality,
        'birthday' => $player_add_birthday,
        'city' => $player_add_city,
        'size' => $player_add_size,
        'weight' => $player_add_weight,
        'team_arrival' => $player_add_team_arrival,
        'game_id' => $player_add_game_id,
        'image' => $player_add_image,
        'twitter' => $player_add_twitter,
        'instagram' => $player_add_instagram,
        'twitch' => $player_add_twitch,
        'game_stats' => $player_add_game_stats,
    ]);
